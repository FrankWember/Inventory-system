...
export const CAMEROONIAN_DRINKS: DrinkTemplate[] = [
  ...
  { name: 'ISENBECK', category: 'Bière', defaultRackSize: 12 },
  ...
  // Jus (Juices)
  { name: 'JUS DE BISSAP', category: 'Jus', defaultRackSize: 12 },
  { name: 'JUS DE GINGEMBRE', category: 'Jus', defaultRackSize: 12 },
  { name: 'JUS D\'ANANAS', category: 'Jus', defaultRackSize: 12 },
